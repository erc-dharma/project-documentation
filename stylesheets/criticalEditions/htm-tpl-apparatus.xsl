  ...
  <xsl:template name="generate-app-link">
    ...
    <xsl:choose>
      <xsl:when test="$location = 'text'">
        ...
        <xsl:if test="//t:lem/@type">
          <xsl:choose>
              <xsl:when test="t:lem/@type='emn'">
                <xsl:text>em. ◇ </xsl:text>
              </xsl:when>
              <xsl:when test="t:lem/@type='norm'">
              <xsl:text>norm. ◇ </xsl:text>
            </xsl:when>
              <xsl:when test="t:lem/@type='conj'">
      ...
      <xsl:choose>
          ...
          <!-- <xsl:when test="child::t:lacunaStart">
             <xsl:text>A lacuna start here</xsl:text>
           </xsl:when>
           <xsl:when test="child::t:lacunaEnd">
             <xsl:text>The lacuna ends here</xsl:text>
           </xsl:when>-->
...
<!--  <xsl:template name="variants">
    <xsl:choose>
      <xsl:when test="not(t:rdg/text())">
          <xsl:text>∅ </xsl:text>
          <xsl:value-of select="t:rdg/@wit"/>
          </xsl:when>
      <xsl:when test="t:rdg">
          <xsl:value-of select="t:rdg/text()"/>
          <xsl:text> </xsl:text>
      </xsl:when>
          <xsl:when test="not(t:rdg) and t:note">
    <xsl:value-of select="t:note"/>
    </xsl:when>
        </xsl:choose>
