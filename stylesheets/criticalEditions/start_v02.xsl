                                    ...
                                    <div class="translation">
                                        <xsl:element name="h2">
                                            <xsl:attribute name="id">Translation<xsl:value-of select="count(tei:text/tei:body/preceding-sibling::tei:div[@type='translation']) + 1"/></xsl:attribute>Translation<xsl:if test="@xml:lang or @resp or @source"><xsl:call-template name="translation-title">
                                                ...
                                                <xsl:with-param name="responsability" select="@resp"/><xsl:with-param name="source" select="@source"/>
 ...
 <!-- call to api github -->
    ...
    <xsl:template name="translation-title">
        ...
        <xsl:if test="$responsability">
            <xsl:text> by </xsl:text>
            <xsl:call-template name="responsibility-display">
            ...
            <xsl:choose>
                <xsl:when test="contains($responsability, ' ')">
                    ...
                    <xsl:if test="$first-id">
                        <xsl:apply-templates select="$list-members//tei:person[@xml:id = $first-id]/child::tei:persName"/>
                        <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:apply-templates select="$list-members//tei:person[@xml:id = substring-after($responsability, 'part:')]/child::tei:persName"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:otherwise>
            </xsl:choose>
    ...
    <xsl:template match="tei:abbr">
        <xsl:choose>
            ...
            <xsl:element name="span">
                ...
                <xsl:attribute name="data-tip">Abbreviated text</xsl:attribute>
                <xsl:apply-templates/>
            </xsl:element>
        </xsl:when>
        ...
        <xsl:choose>
           ...
           <xsl:when test="parent::tei:subst">
               <xsl:element name="span">
                   ...
                   <xsl:attribute name="data-tip">Scribal addition made in the space where a previous string of text has been erased (overwritten text: &lt;span class&quot;del&quot;&gt;⟦<xsl:value-of select="tei:del"/>⟧&lt;span&gt;</xsl:attribute>
                   <xsl:if test="@hand">
                       <xsl:text> H</xsl:text>
                ...
                <xsl:element name="span">
                    ...
                    <xsl:element name="span">
                        ...
                        <xsl:element name="span">
                            <xsl:attribute name="class">
                                    <xsl:choose><xsl:when test="not(child::tei:lem/following-sibling::tei:note[@type='altLem'])">
                    ...
                    <xsl:if test="tei:lem">
                        ...
                        <xsl:if test="tei:lem[@type='omitted_elsewhere']">
                            ...
                            <xsl:element name="b">
                                <xsl:if test="following-sibling::*[local-name()='witDetail'] or @varSeq"><xsl:attribute name="class">supsub</xsl:attribute></xsl:if>
                                <xsl:call-template name="tokenize-witness-list">
                                    <xsl:with-param name="string" select="tei:lem/following-sibling::*[local-name()='witDetail'][1]/@wit"/>
        ...
        <xsl:choose>
            <xsl:when test="$bib-type='book'">
                <xsl:for-each select="$bib-content//tei:monogr/tei:author">
                 ...
                 <xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:date"/>.<xsl:text> </xsl:text><i><xsl:apply-templates select="$bib-content//tei:monogr/tei:title[@level='m']"/></i>.<xsl:if test="$bib-content//tei:monogr/tei:edition"><xsl:text> </xsl:text><xsl:apply-templates select="$bib-content//tei:monogr/tei:edition"/>.</xsl:if><xsl:if test="$bib-content//tei:monogr/tei:series"><xsl:text> </xsl:text><xsl:apply-templates select="$bib-content//tei:monogr/tei:series/tei:title[@level='s']"/> <xsl:apply-templates select="$bib-content//tei:monogr/tei:series/tei:biblScope"/>.</xsl:if> <xsl:text> </xsl:text><xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:pubPlace"/>: <xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:publisher"/>. <xsl:if test="$bib-content//tei:monogr/tei:imprint/tei:note[@type='url']"><xsl:element name="a"><xsl:attribute name="href"><xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:note[@type='url']"/></xsl:attribute>[URL].</xsl:element></xsl:if>
            </xsl:when>
            ...
            <xsl:when test="$bib-type='journalArticle'">
                ...
                . <xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:date"/>.<xsl:text> “</xsl:text><xsl:apply-templates select="$bib-content//tei:analytic/tei:title[@level='a']"/><xsl:text>.”</xsl:text> <xsl:element name="abbr">
                    <xsl:attribute name="data-tip">&lt;i&gt;<xsl:apply-templates select="$bib-content//tei:monogr/tei:title[@level='j']"/>&lt;/i&gt;</xsl:attribute><i><xsl:apply-templates select="$bib-content//tei:monogr/tei:title[@level='j']"/></i></xsl:element> <xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:biblScope[@unit='volume']"/><xsl:if test="$bib-content//tei:monogr/tei:imprint/tei:biblScope[@unit='issue']"> (<xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:biblScope[@unit='issue']"/>)</xsl:if><xsl:text>, pp. </xsl:text><xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:biblScope[@unit='unit']"/><xsl:text>.</xsl:text><xsl:if test="$bib-content//tei:analytic/tei:idno[@type='DOI']"><xsl:element name="a"><xsl:attribute name="class">url</xsl:attribute><xsl:attribute name="href">https://doi.org/<xsl:apply-templates select="$bib-content//tei:analytic/tei:idno[@type='DOI']"/></xsl:attribute>DOI: <xsl:apply-templates select="$bib-content//tei:analytic/tei:idno[@type='DOI']"/></xsl:element>. </xsl:if><xsl:if test="$bib-content//tei:monogr/tei:imprint/tei:note[@type='url']"><xsl:element name="a"><xsl:attribute name="href"><xsl:apply-templates select="$bib-content//tei:monogr/tei:imprint/tei:note[@type='url']"/></xsl:attribute>[URL].</xsl:element></xsl:if>
    ...
    <xsl:template match="tei:citedRange">
                    ...
                    <b><xsl:call-template name="citedRange-unit"/>
                    <xsl:apply-templates select="replace(normalize-space(.), '-', '–')"/></b>
        ...
        <xsl:choose>
            ...
            <xsl:when test="parent::tei:subst">
                <xsl:element name="span">
                    ...
                    <xsl:attribute name="data-tip">Scribal deletion: corrected text (replacement text: &lt;span class&quot;add&quot;&gt;⟨⟨<xsl:value-of select="tei:add"/>⟩⟩&lt;span&gt;</xsl:attribute>
                    <xsl:if test="@hand">
                        <xsl:text> H</xsl:text>
                        <xsl:element name="sub">
                            <xsl:value-of select="substring-after(@hand, '_H')"/>
            ...
            <xsl:when test="child::tei:gap">
                <span class="del" data-tip="Scribal deletion">⟦<xsl:apply-templates/>⟧</span>
            </xsl:when>
            <!-- condition en dehors de subst -->
            <xsl:otherwise>
        <span class="del" data-tip="Scribal deletion: text struck through or cross-hatched">⟦<xsl:apply-templates/>⟧</span> 
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
                ...
                <xsl:choose>
                    <xsl:when test="$prosody//tei:item[tei:seg[@type='xml'] =$metrical][1]">
                        ...
                        <xsl:text> class: </xsl:text>
                            <span class="prosody"><xsl:value-of select="translate($prosody//tei:item[tei:seg[@type='xml']]/tei:seg[@type='prosody'], '-=+', '⏑⏓–')"/></span>
                        </span>
                    </xsl:when>
                    <xsl:otherwise>
...
<!--        <xsl:apply-templates/>
    ...
    <xsl:template match="tei:lb">
        <xsl:if test="@break='yes'"><span class="hyphen-break" data-tip="Hyphen break">-</span></xsl:if>
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:choose>
                    <xsl:when test="$edition-type='diplomatic'">
                        <xsl:call-template name="lbrk-app"/>
                        <xsl:element name="span">
                            <xsl:attribute name="class">pagelike</xsl:attribute>
                            <xsl:attribute name="data-tip">Page start</xsl:attribute>
                            <xsl:attribute name="id"><xsl:value-of select="@xml:id"/></xsl:attribute>
                    ...
                    <xsl:when test="$edition-type='critical'">
                        <xsl:element name="span">
                            <xsl:attribute name="class">pagelike</xsl:attribute><xsl:attribute name="data-tip">Page start</xsl:attribute>
                            <xsl:text>⟨</xsl:text>
                            <xsl:call-template name="tokenize-witness-list">
    ...
    <xsl:template name="launch-app">
        <xsl:element name="div">
            <xsl:attribute name="class">col-2 apparat-col text-center</xsl:attribute>
        ...
        <xsl:variable name="apparatus-reformulation">
            ...
            <xsl:element name="span">
                <xsl:element name="span">
                    ...
                    <xsl:element name="span">
                    <xsl:attribute name="class">
                        <xsl:text>reading-line reading</xsl:text>
                    </xsl:attribute>
                        <xsl:element name="span">
                            <xsl:attribute name="class">app-rdg</xsl:attribute>
                            <xsl:apply-templates/>
...
-->                    <xsl:when test="@reason='omitted'">
  ...
  <xsl:template name="tpl-apparatus">
    ...
    <xsl:if
        test=".//tei:app[not(parent::tei:listApp[@type='parallels'] or @rend='hide' or preceding-sibling::tei:span[@type='reformulationEnd'][1])]| .//tei:note[last()][parent::tei:p or parent::tei:lg or parent::tei:l][not(ancestor::tei:div[@type='translation'])] | .//tei:span[@type='omissionStart'] | .//tei:span[@type='reformulationStart'] | .//tei:l[@real]"> <!-- .//tei:choice | .//tei:subst |  -->
   ...
   <!-- <xsl:template name="tpl-notes-trans">
    ...
    <xsl:template name="dharma-app">
       ...
       <xsl:variable name="childtype">
        ...
        <xsl:choose>
            <xsl:when test="not(ancestor::tei:choice or ancestor::tei:subst) or //tei:note[last()][parent::tei:p or parent::tei:lg or parent::tei:l][not(ancestor::tei:div[@type='translation'])] ">
            ...
            <xsl:when test="$apptype='reformulation'">
                <xsl:if test="self::tei:span[@type='reformulationStart']">
                    ...
                    <xsl:element name="span">
                        ...
                        <xsl:element name="span">
                            <xsl:attribute name="class">
                                <xsl:text>reading bottom-reading-line</xsl:text>
                            </xsl:attribute>
                                <xsl:apply-templates/>
