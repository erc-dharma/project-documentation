   ...
   <!-- main display structure - appelle les templates et les modes-->
    ...
    <xsl:template match="tei:app[not(@rend='hide')]" mode="modals">
        <xsl:variable name="apparatus">
            <!--<xsl:element name="span">-->
            <xsl:variable name="id-segment" select="tei:lem[@type='transposition']/ancestor::*/matches(@xml:id, 'trsp\d\d\d')"/>
                <xsl:element name="span">
                    ...
                    <xsl:element name="span">
                        ...
                        <xsl:element name="span">
                            ...
                            <xsl:choose>
                                ...
                                <!--<xsl:when test="tei:lem[parent::tei:app[@type='transposition']]">
                    ...
                    <xsl:if test="tei:lem">
                        ...
                        <xsl:if test="tei:lem[@type='transposition'][ancestor::tei:lg[not(@xml:id)]][following-sibling::tei:rdg[child::tei:*[@corresp]]]">
                            <xsl:element name="span">
                            ...
                            <xsl:for-each select="tei:lem[@type='transposition']/following-sibling::tei:rdg/tei:l">
                        ...
                        <xsl:if test="tei:lem/@wit">
                                    ...
                                    <xsl:attribute name="class">font-weight-bold <xsl:if test="tei:lem/following-sibling::*[local-name()='witDetail'] or tei:lem/@varSeq">supsub</xsl:if>
                                            ...
                                            <xsl:call-template name="tokenize-witness-list">
                                                <xsl:with-param name="string" select="tei:lem[not(@type='transposition')]/@wit"/>
                        ...
                        <xsl:if test="tei:lem[@type='transposition'][not(ancestor::tei:lg)]">
                            <xsl:text> (</xsl:text>
            ...
            <xsl:if test="tei:rdg[not(@type='paradosis' or  @type='transposition')][not(preceding-sibling::tei:lem[@type='transposition'])]">
                            <xsl:element name="hr"/>
...
<!--        <xsl:apply-templates/>
    ...
    <xsl:template match="tei:note">
        <xsl:choose>
            ...
            <xsl:when test="tei:note[@type='reformulation']"/>
...
<!--    <xsl:template match="tei:span">
        ...
        <xsl:if test="self::tei:span[@type='omissionStart']">
                    <xsl:element name="span">
                        ...
                        <xsl:element name="a">
                            ...
                            <xsl:if test="self::tei:span[@type='omissionStart']/following::tei:*[@wit = $wit-omission][tei:span[@type='omissionEnd']][1]/ancestor::tei:app/parent::tei:*[1][local-name ()= ('lg', 'ab', 'p')][not(parent::tei:div[@type='dyad'])]">
                                <xsl:text>.</xsl:text>
                                <xsl:choose>
                ...
                <xsl:element name="span">
                    ...
                    <xsl:element name="span">
                        ...
                        <xsl:element name="span">
                            <xsl:attribute name="class">font-weight-bold</xsl:attribute>
                            <xsl:call-template name="tokenize-witness-list">
                                <xsl:with-param name="string" select="self::tei:span[@type='reformulationStart']/following::tei:witDetail[@type='retained'][1]/@wit"/>
                            </xsl:call-template>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="hr"/>
                    <xsl:for-each select="self::tei:span[@type='reformulationStart']/following::tei:span[@type='reformulationEnd'][$reformulation-id = substring-after(@corresp, '#')][1]/following-sibling::tei:witDetail[@type='rejected'][1]">
                    <xsl:element name="span">
                    <xsl:attribute name="class">
                        ...
                        <xsl:element name="hr"/>
                    <xsl:for-each select="self::tei:span[@type='reformulationStart']/following::tei:span[@type='reformulationEnd'][$reformulation-id = substring-after(@corresp, '#')][1]/following-sibling::tei:note[@type='reformulation'][1]">
                        <xsl:element name="span">
                            <xsl:attribute name="class">note-line</xsl:attribute>
                            <xsl:apply-templates/>
                        </xsl:element>
  ...
  <xsl:template name="tpl-apparatus">
    ...
    <xsl:if
        test=".//tei:app[not(parent::tei:listApp[@type='parallels'] or @rend='hide')]| .//tei:note[last()][parent::tei:p or parent::tei:lg or parent::tei:l][not(//tei:TEI[@type='translation'])] | .//tei:span[@type='omissionStart'] | .//tei:span[@type='reformulationStart'] | .//tei:l[@real]"> <!-- .//tei:choice | .//tei:subst |  -->
        ...
        <xsl:param name="type"/>
            ...
            <xsl:if test="$location = 'bottom'">
                <a>
                    ...
                    <xsl:text>^</xsl:text>
                   <!-- <xsl:value-of select="$app-num"/>-->
                    <xsl:number level="any" count="//tei:app[not(parent::tei:listApp[@type='parallels'] or @rend='hide')] | //tei:note[last()][parent::tei:p or parent::tei:lg or parent::tei:l][not(//tei:TEI[@type='translation'])] | //tei:note[parent::tei:ab[preceding-sibling::tei:lg][1]] | .//tei:span[@type='omissionStart'] | .//tei:span[@type='reformulationStart']| .//tei:l[@real] |.//tei:lacunaStart"/>
                </a>
            </xsl:if>
                ...
                <xsl:for-each select="tei:lem">
                    <xsl:element name="span">
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="$path/tei:lem[@type='transposition']"/>
                    ...
                    <xsl:if test="not($path/tei:lem[@type='transposition'])">
                        <xsl:element name="span">
                        <xsl:attribute name="class">font-weight-bold</xsl:attribute>
                        <xsl:text>]</xsl:text>
                    </xsl:element>
                    ...
                    <xsl:if test="self::tei:lem[@type='transposition'] and ancestor::tei:lg">
                        ...
                        <xsl:text> presents the lines in order </xsl:text>
                        <xsl:for-each select="following-sibling::tei:rdg/tei:l">
                            <xsl:variable name="id-corresp" select="substring-after(@corresp, '#')"/>
                            <xsl:value-of select="parent::tei:rdg/preceding-sibling::tei:lem[@type='transposition']/child::tei:l[@xml:id = $id-corresp]/@n"/>
                        </xsl:for-each>
                    </xsl:if>
                    ...
                    <!--<xsl:if test="self::tei:lem[parent::tei:app[@type='transposition']]">
                        <xsl:text> (</xsl:text>
                        <xsl:value-of select="self::tei:lem/parent::tei:app/@type"/>
                        <xsl:text>)</xsl:text>
                    </xsl:if>-->
                        <xsl:if test="@source">
                                <xsl:call-template name="source-siglum">
            ...
            <xsl:when test="$apptype='reformulation'">
                <xsl:if test="self::tei:span[@type='reformulationStart']">
                    ...
                    <xsl:element name="span">
                        ...
                        <xsl:if test="self::tei:span[@type='reformulationStart']/following::tei:span[@type='reformulationEnd'][$reformulation-id = substring-after(@corresp, '#')][1]/following-sibling::tei:witDetail[@type='rejected'][1]">
                        <xsl:text>, </xsl:text>
                    </xsl:if>
                        ...
                        <xsl:if test="self::tei:span[@type='reformulationStart']/following::tei:span[@type='reformulationEnd'][$reformulation-id = substring-after(@corresp, '#')][1]/following-sibling::tei:note[@type='reformulation'][1]"> • </xsl:if>
                        <xsl:for-each select="self::tei:span[@type='reformulationStart']/following::tei:span[@type='reformulationEnd'][$reformulation-id = substring-after(@corresp, '#')][1]/following-sibling::tei:note[@type='reformulation'][1]">
                        <xsl:element name="span">
                            <xsl:attribute name="class">bottom-note-line</xsl:attribute>
                            <xsl:apply-templates/>
