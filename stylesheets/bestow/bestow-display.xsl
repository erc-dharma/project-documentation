        ...
        <xsl:choose>
            <xsl:when test=".[tei:ptr]">
                ...
                <xsl:variable name="zoteroomitname">
                    <xsl:value-of
                        select="unparsed-text(replace(concat('https://dharmalekha.info/zotero-proxy/extra?shortTitle=', encode-for-uri($biblentry), '&amp;format=json'), 'amp;', ''))"
                    />
                </xsl:variable>
                ...
                <xsl:variable name="zoteroapijson">
                    <xsl:value-of
                        select="replace(concat('https://dharmalekha.info/zotero-proxy/extra?shortTitle=', encode-for-uri($biblentry), '&amp;format=json&amp;style=',$zoteroStyle,'&amp;include=citation'), 'amp;', '')"/>
                </xsl:variable>
                ...
                <xsl:variable name="bibwitness">
                    <xsl:value-of select="replace(concat('https://dharmalekha.info/zotero-proxy/extra?shortTitle=', encode-for-uri($biblentry), '&amp;format=bib&amp;style=', $zoteroStyle), 'amp;', '')"/>
                </xsl:variable>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:copy-of
                            select="document(replace(concat('https://dharmalekha.info/zotero-proxy/extra?shortTitle=', encode-for-uri($biblentry), '&amp;format=bib&amp;style=',$zoteroStyle), 'amp;', ''))/div"/>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:when>
