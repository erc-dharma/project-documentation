...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="url-data" select="unparsed-text('https://api.github.com/repos/erc-dharma/mdt-texts/contents/csv')"/>
    <xsl:param name="name-file">
        <xsl:analyze-string select="$url-data"
            regex="(&quot;download_url&quot;:\s+&quot;)(.+)(&quot;,)">
