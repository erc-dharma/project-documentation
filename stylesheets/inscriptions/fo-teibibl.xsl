				...
				<xsl:choose>
					...
					<xsl:when test=".[t:ptr]">
						...
						<xsl:variable name="zoteroapitei">
							...
							<xsl:value-of select="concat('http://195.154.222.146:8024/',$parm-zoteroUorG,'/',$parm-zoteroKey,'/items?tag=', $biblentry, '&amp;format=tei')"/>
						...
						<xsl:variable name="zoteroapijson">
							<xsl:value-of select="concat('http://195.154.222.146:8024/',$parm-zoteroUorG,'/',$parm-zoteroKey,'/items?tag=', $biblentry, '&amp;format=json&amp;style=',$parm-zoteroStyle,'&amp;include=citation')"/>
						</xsl:variable>
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								...
								<xsl:copy-of select="document(concat('http://195.154.222.146:8024/',$parm-zoteroUorG,'/',$parm-zoteroKey,'/items?tag=', $biblentry, '&amp;format=bib&amp;style=',$parm-zoteroStyle))/div"/>
